#!/usr/bin/env bash
#SBATCH --job-name=arkplus-convnext-base
...
# Examples:
# ./apptainer-run-arkplus-convnext-base.sh dataset_dir=$XRAY_DATASET debug=true ark.pretrain_epochs=1
# ./apptainer-run-arkplus-convnext-base.sh 4 ark.global_batch_size=200 ark.workers=8
